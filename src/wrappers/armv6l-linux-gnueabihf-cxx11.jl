# Autogenerated wrapper script for xtrx_jll for armv6l-linux-gnueabihf-cxx11
export libXTRXSupport, liblms7compact, libxtrx, libxtrxdsp, libxtrxll, test_xtrx, test_xtrxflash, test_xtrxll
...
JLLWrappers.@declare_executable_product(test_xtrx)
